...
export const EVENTS = [
   {
      ...
      videoCaption: "Organizing committee and volunteers — RUNSA Legislative Summit 2026",
      modal: {
         tag: "Past Event",
         title: "Legislative Parliamentary Summit",
   ...
   },
   {
      ...
      status: "completed",
      type: "past",
      title: "GRIP Campus Tour — Global Generation Rooted in Purpose",
      org: "GRIPGlobal × Woodhall Capital International Foundation × RUNSA",
      date: "April 28, 2026",
      loc: "SAPETRO Lecture Theatre, Redeemer's University",
      role: "Protocol Officer · Redeemer's University Protocol Team",
      desc: "Campus tour conference — Global Generation Rooted in Purpose. 700 seats. 1,850+ participants reached across the tour. 12+ internship slots unlocked. Speakers: Mrs. Mojisola Hunponu-Wusu (Founder, Woodhall Capital) and Mr. Viavo Hunponu-Wusu. Served at the main entrance as Protocol Officer.",
      image: "/events/grip-ibk-protocol.jpg",
      images: [
         { src: "/events/grip-ibk-protocol.jpg", caption: "Protocol Officer — GRIP Campus Tour, Redeemer's University", alt: "IBK as Protocol Officer at GRIP Campus Tour" },
         { src: "/events/grip-ibk-portrait.jpg", caption: "IBK at the GRIP Campus Tour", alt: "IBK at GRIP Campus Tour backdrop" },
         { src: "/events/grip-audience.jpg", caption: "700 seats — SAPETRO Lecture Theatre", alt: "Packed audience at GRIP Campus Tour" },
         { src: "/events/grip-speaker-stage.jpg", caption: "Mrs. Mojisola Hunponu-Wusu — Founder, Woodhall Capital", alt: "Mojisola Hunponu-Wusu speaking at GRIP Campus Tour" },
         { src: "/events/grip-speaker-podium.jpg", caption: "Session in progress — GRIP Campus Tour", alt: "Speaker at GRIP Campus Tour podium" },
         { src: "/events/grip-speaker-2.jpg", caption: "GRIP Campus Tour session — SAPETRO Theatre", alt: "Speaker at GRIP Campus Tour" },
         { src: "/events/grip-thankyou.jpg", caption: "1,850+ participants reached across the GRIP Campus Tour", alt: "GRIP Campus Tour thank you graphic" },
         { src: "/events/grip-flyer.jpg", caption: "GRIP RUN — Redeemer's University, April 28, 2026", alt: "GRIP Campus Tour flyer" },
      ],
      video: "/events/grip-highlights.mp4",
      videoCaption: "GRIP Campus Tour — Redeemer's University highlights",
      modal: {
         tag: "Past Event",
         title: "GRIP Campus Tour — Redeemer's University",
         subtitle: "April 28, 2026 · SAPETRO Lecture Theatre, Redeemer's University",
         desc: "Served as Protocol Officer with the Redeemer's University Protocol Team at the GRIP Campus Tour — Day Two of RUNSA Week 2026 (The Belle Epoque). Stationed at the main entrance, responsible for guest access control for 700+ attendees including distinguished speakers Mrs. Mojisola Hunponu-Wusu and Mr. Viavo Hunponu-Wusu of Woodhall Capital.",
         specs: [
            { l: "Organizer", v: "GRIPGlobal × Woodhall Capital International Foundation × RUNSA" },
            { l: "Role", v: "Protocol Officer — Main Entrance" },
            { l: "Date", v: "April 28, 2026" },
            { l: "Location", v: "SAPETRO Lecture Theatre, Redeemer's University, Ede" },
            { l: "Capacity", v: "700 seats" },
            { l: "Tour Impact", v: "1,850+ participants · 12+ internship slots · 2 countries" },
            { l: "Key Speakers", v: "Mrs. Mojisola Hunponu-Wusu · Mr. Viavo Hunponu-Wusu" },
            { l: "Context", v: "Day Two — RUNSA Week 2026 (The Belle Epoque)" },
         ],
      },
   },
   {
